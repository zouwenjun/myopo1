/**
 * Created by bjwsl-001 on 2017/3/13.
 */
/*广告图片数组*/
var imgs=[
    {"img":"images/banner/banner_11.jpg"},
    {"img":"images/banner/banner_12.jpg"},
    {"img":"images/banner/banner_13.jpg"},
    {"img":"images/banner/banner_14.jpg"},
...
var slider={
    ...
    init(){
        ...
        me.$ulImgs.on("mouseover","li>img",function(e){
            ...
            me.moved=i;//修改moved等于i,如果是最后一张就不移动
